...
import { ArrowLeft, Calendar, Clock, BookOpen, TrendingUp, Save } from "lucide-react";
          ...
          <div>
            <Card className="shadow-md">
              <CardHeader>
                ...
                <CardDescription>
                  Completa los detalles de tu semana de práctica
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      placeholder="Describe las principales tareas y proyectos en los que trabajaste esta semana..."
                      value={activities}
                  ...
                  <div>
                    ...
                    <Textarea
                      placeholder="¿Qué nuevas habilidades, conocimientos o experiencias adquiriste?"
                      value={learnings}
